...
Also in server and client configuration file that can be found in theJSONconf folder modify the client and server addresses with the local address of server and client.
